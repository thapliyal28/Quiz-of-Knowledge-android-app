...
public class GameStart extends Activity {
    ...
    String q[]={
            ...
            "Entomologyis the science that studies?",
    ...
    String a[]={"yukon-Canada","Behaviour of Human Beings","Labour Party","Argentina, Australia, Belgium and South Africa","by soil erosion","Faraday","October","WWE","4","Length","6","Ear","Asia","Earring","1857","Argentina","Autumn","Red"
    ...
    String b[]={"East Antartica","Insects","Nazi Party","Chili, France and Japan","by wind erosion","Baird","November","TEZ","1","Millimeter","7","Stomach","Australia","Glass Slipper",
    ...
    String c[]={"Alaska","study of panets","Ku-Klux-Klan","New Zealand, Norway, the former USSR, the UK and the USA","of its mineral content","Edison","January","OWO","3","Yard","8","Head","Europe","Ring","1867","Brazil","Summer",
    ...
    String d[]={"Eismitte-Greenland","Formation of rocks","Democratic Party","All of the above","by weathering","Marconi","September","TWO","2","Meter","4","Foot","Africa","Purse","1861","Russia","Winter",
